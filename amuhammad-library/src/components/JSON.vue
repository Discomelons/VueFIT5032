  ...
  <div class="json-lab">
    ...
    <section class="lab-section">
     ...
     <ul>
        <li v-for="work in austen.famousWorks" :key="work.title">
            Austin's Works include: {{ work.title }}
        </li>
      </ul>
    ...
    <section class="lab-section">
      ...
      <p>
        ...
        Bookstore Name: {{bookstores.name}}
      </p>

      <p>
        Total Stores:
        <!-- Activity 9b: Get the total number of stores from the bookstores object. -->
        Bookstores: {{  bookstores.totalStores }}
      </p>
      ...
      <p>We operate in: {{ bookstores.countries }}</p>
...
const styleAuthors = ref(false)
const highlightBgColor = ref('#e6f7ff')
